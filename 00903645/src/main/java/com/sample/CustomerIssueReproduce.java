...
public class CustomerIssueReproduce {
	...
	private static void reproduce(WorkflowProcess process) {
    	...
    	System.out.println("	return 1==(Integer)kcontext.getVariable(\"myVar\");");
    	System.out.println("	return 2==(Integer)kcontext.getVariable(\"myVar\");");
    	System.out.println("The Constraint get from  org.jbpm.ruleflow.core.RuleFlowProcess");
	...
	public static StatefulKnowledgeSession createKSession(){
        ...
        kbuilder.add(new ClassPathResource("GatewayEvaluationJava.bpmn"), ResourceType.BPMN2);
