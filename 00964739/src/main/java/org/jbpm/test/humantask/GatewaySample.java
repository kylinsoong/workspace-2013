...
//		ksession.startProcess("com.sample.bpmn.hello", procVar);
//	}

	private static final String JBPM5_BASIC_NAME = "gatewaySample.bpmn";
	...
	public static void main(String[] args) throws Exception {
		...
		// myVar 1 Task1 execute, Task2 abort
		// myVar 2 Task1 abort, Task2 execute
		// we execute Task1 this time
		params.put("myVar", new Integer("1"));
